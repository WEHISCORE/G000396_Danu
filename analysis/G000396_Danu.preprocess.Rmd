...
Although Figures \@ref(fig:mds-by-plate-number) - \@ref(fig:mds-by-library-size) are only a preliminary summary of the data, there are few patterns worth highlighting:
